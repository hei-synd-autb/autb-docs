...
> A la fin de ce module, vous devriez être capable de passer commande et vérifier les principaux paramètres de ce genre de système:

 <figure>
    <img src="./img/Schematic Example 4 Axis Handling Solution.png"
         alt="Schematic Example 4 Axis Handling Solution">
    <figcaption>Schematic Example 4 Axis Handling Solution, source: Bosch Rexroth</figcaption>
</figure>

## Physique et mathématique **(A mettre ailleurs)**
Les systèmes mécaniques considérés offrent l'intérêt d'utiliser des notions de physique et mathématique, première et deuxième dérivée, sans qu'elles soient une barrière à la compréhension du sujet.

Certains aspects qui demanderaient des connaissances plus avancées avec des comportements non linéaires, comme les roulements à bille, ne seront pas développés.

## Technique de régulation avancée
 **(A mettre ailleurs)**

# Mécanique, Instrumentation, Régulation
Le but de ce chapitre n'est pas de revenir ou de remplacer certaines notions vues dans d'autres cours, comme par exemple les capteurs, mais de mettre le point sur certaines caractéristiques importantes dès lors que l'on assemble ces différents systèmes pour les insérer dans un système d'automation industrielle.
