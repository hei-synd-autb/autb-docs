...
> > Ce cas particulier illustre un type de moteur, qui de par sa construction sur deux phases est **impossible de piloter sans une commande d'axe spécifique**.

<div align="center">
    <a href="https://linmot.com/">
        <img src="./img/linearmotor-p01.jpg" alt="Source Linmoz" width="400">
    </a>
    <p><em>Cylindre électrique d'origine Linmot</em></p>
</div>
...
<div align="center">
    <a href="https://www.renishaw.com">
        <img src="./img/RenishawAccuracyMachineToolTouchProbes.jpg" alt="Source Linmoz" width="400">
    </a>
    <p><em>Accuracy Machine Tool Touch Probes, Source Renishaw</em></p>
</div>
...
> **Attention**, pour ce genre d'application il faudra obtenir un firmware spécifique qui permette de dépasser la limite habituelle des commnandes moteur fixée à 599 [Hz].
...
> **Attention** : Les moteurs linéaires sont souvent livrés sans encapsultation mécanique et doivent faire l'objet d'une conception mécanique complète.
...
<div align="center">
    <a href="https://www.boschrexroth.com">
        <img src="./img/RexrothGear.jpg" alt="Source Rexroth" width="300">
    </a>
    <p><em>Renishaw Absolute Linear Encoder</em></p>
</div>
...
<div align="center">
    <a href="https://www.igus.eu/">
        <img src="./img/Igus e-chains-weitere-loesung_570.jpg" alt="Source Igus" width="300">
    </a>
    <p><em>Câbles et  les chaînes porte-câbles</em></p>
</div>
